...
// CustomStatusApplyConfiguration represents an declarative configuration of the CustomStatus type for use
// with apply.
type CustomStatusApplyConfiguration struct {
	AvailableReplicas *int32 `json:"availableReplicas,omitempty"`
}

// CustomStatusApplyConfiguration constructs an declarative configuration of the CustomStatus type for use with
// apply.
func CustomStatus() *CustomStatusApplyConfiguration {
	return &CustomStatusApplyConfiguration{}
}
